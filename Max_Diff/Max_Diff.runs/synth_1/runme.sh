...
HD_PWD='/media/viktor/Setup/Workstorage/RTL_Designs/Diff_max/Max_Diff/Max_Diff.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Max_Diff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Max_Diff.tcl
