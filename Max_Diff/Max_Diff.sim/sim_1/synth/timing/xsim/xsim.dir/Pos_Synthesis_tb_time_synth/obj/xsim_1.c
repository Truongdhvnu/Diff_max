...
{
	iki_relocate(dp, "xsim.dir/Pos_Synthesis_tb_time_synth/xsim.reloc",  (void **)funcTab, 1348);
	iki_vhdl_file_variable_register(dp + 1047904);
	iki_vhdl_file_variable_register(dp + 1047960);
...
{
	iki_sensitize(dp, "xsim.dir/Pos_Synthesis_tb_time_synth/xsim.reloc");
}
...

{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1053248, dp + 1056296, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1053304, dp + 1054728, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1053360, dp + 1055792, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1053568, dp + 1055680, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1053624, dp + 1054896, 0, 7, 0, 7, 8, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1053720, dp + 1055232, 0, 0, 0, 0, 1, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1053816, dp + 1054616, 0, 7, 0, 7, 8, 1);

	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 1053856, dp + 1055344, 0, 7, 0, 7, 8, 1);

}

void simulate(char *dp)
{
		iki_schedule_processes_at_time_zero(dp, "xsim.dir/Pos_Synthesis_tb_time_synth/xsim.reloc");
	wrapper_func_0(dp);
...
int main(int argc, char **argv)
{
    ...
    iki_set_sv_type_file_path_name("xsim.dir/Pos_Synthesis_tb_time_synth/xsim.svtype");
    iki_set_crvs_dump_file_path_name("xsim.dir/Pos_Synthesis_tb_time_synth/xsim.crvsdump");
    void* design_handle = iki_create_design("xsim.dir/Pos_Synthesis_tb_time_synth/xsim.mem", (void *)relocate, (void *)sensitize, (void *)simulate, 0, isimBridge_getWdbWriter(), 0, argc, argv);
